...
def get_font(size):  # Returns Press-Start-2P in the desired size
    return pygame.font.Font("assets/start_screen/font.ttf", size)
...
def main_menu():
    while True:
        ...
        PLAY_BUTTON = Button(image=pygame.image.load("assets/start_screen/Play Rect.png"), pos=(640, 250),
                             text_input="PLAY", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        OPTIONS_BUTTON = Button(image=pygame.image.load("assets/start_screen/Options Rect.png"), pos=(640, 400),
                                text_input="OPTIONS", font=get_font(75), base_color="#d7fcd4", hovering_color="White")
        QUIT_BUTTON = Button(image=pygame.image.load("assets/start_screen/Quit Rect.png"), pos=(640, 550),
